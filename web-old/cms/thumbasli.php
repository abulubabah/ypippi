...
$perbandingan=$tinggiasli/$lebarasli;
$lebarbaru=150;
$tinggibaru=$perbandingan*$lebarbaru;
...
if($tipe=="image/jpeg") { imagejpeg($kecil,NULL,80); } 
elseif($tipe=="image/jpg") { imagejpeg($kecil,NULL,80); } 
elseif($tipe=="image/png") { imagepng($kecil,NULL,80); } 
elseif($tipe=="image/gif") {  imagegif($kecil,NULL,80); } 
else { return false; }
imagedestroy($kecil);
?>